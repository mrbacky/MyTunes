...
/**
 *
 * @author Radoslav, Anne, Abdi, Michael
 */
public class PrimaryController implements Initializable {

    /**
     * This covers all of the buttons used for the program, all created inside
     * SceneBuilder and saved within the fxml files - mytunes.gui.view == Primary Scene
     * 
     */
    @FXML
    ...
    /**
     * Sets the tables details for the table views and columns 
     * title, artist, genre, time of song, name, nr. of songs,
     * 
     */
    ...
    /**
     * Handles the deleting of songs, DeleteSongScene will pop up and ask the user
     * whether they confirm their choice
     * 
    ...
    /**
     * Refreshes library when song is added, removed, updated (details), filtered
     * 
     */
    ...
    /** 
     * Handles the creation of playlists,PlaylistScene pops up and the user
     * can name it 
     * 
    ...
    /**
     * Handles the deleting of playlists, DeletePlaylistScene will pop up in order
     * for the user to confirm or not
     * 
    ...
    /**
     * Handles the moving of songs down, limit implemented so it won't move out of
     * the table
   ...
   /**
   * Handles the backing songs, sends current playing song back to previous song
   * 
